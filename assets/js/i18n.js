...
(function () {
  ...
  var STRINGS = {
    ...
    'hint.unrolled':  ['Select a scroll to open it, then drag to travel and scroll to magnify.',
                       ...
                       'קלייבט א מגילה צו עפענען; שלעפט זיך דערויף ארום און פארגרעסערט צו באטראכטן יעדן פרט.'],
    ...
    'std.p1':         ['First-hand sources where available. Reliable sources where needed.<br>Unverified sources are not used.',
                       ...
                       'ערשטהאנטיגע מקורות וואו זיי זענען פאראן; פארלעסלעכע מקורות וואו עס פעלט אויס.<br>וואס איז נישט באשטעטיגט, גייט נישט אריין אינעם ווערק.'],
    'std.p2':         ['Each work is scoped individually according to its material, depth, format and finish &mdash; and is prepared as a single, unrepeated object.',
                       ...
                       'יעדער ווערק ווערט באזונדער אויסגעמאסטן לויטן חומר, טיפקייט פון פארשונג, פארמאט און אויספיר — און ווערט באשאפן אלס אן איינמאליגער ווערק וואס ווערט נישט איבערגעמאכט.'],
